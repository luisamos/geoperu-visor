...
L.Format.GML = L.Format.Base.extend({
  ...
  generateLayer: function (feature) {
    ...
    var geometryField = undefined;
    if(geometryField === undefined) geometryField = feature.getElementsByTagNameNS(this.namespaceUri, 'Shape')[0];
    if(geometryField === undefined) geometryField = feature.getElementsByTagNameNS(this.namespaceUri, 'the_geom')[0];
    if(geometryField === undefined) geometryField = feature.getElementsByTagNameNS(this.namespaceUri, 'geom')[0];
