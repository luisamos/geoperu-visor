...
!function (t, e, i) {
    L.drawVersion = "0.4.9",
            ...
            draw:
            {
                ...
                handlers:
                {
                    ...
                    marker:
                    {
                        tooltip:
                        {
                            start: "Click en algún lugar del mapa para dibuar un marcador."
                        }
                    },
                    polygon:
                    {
                        tooltip:
                        {
                            ...
                            cont: "Click para continuar dubujando la forma.",
                            end: "Click en el primer punto para terminar la forma."
                        }
                    },
                    polyline:
                    {
                        ...
                        tooltip:
                        {
                            ...
                            end: "Click en el último punto para finalizar la línea."
                        }
                    },
                    rectangle:
                    {
                        tooltip:
                        {
                            start: "Click y arrastre para dibujar un rectángulo."
                        }
                    },
                    simpleshape:
                    {
            ...
            edit:
            {
                ...
                handlers:
                {
                    edit:
                    {
                        tooltip:
                        {
                            text: "Arrastre el marcador para editar la función.",
                    ...
                    remove:
                    {
                        tooltip:
                        {
                            text: "Click sobre el dibujo para eliminarlo"
                        }
                    }
                }
            }
        ...
        L.Draw.Feature = L.Handler.extend({
            includes: L.Evented.prototype, // includes: L.Mixin.Events, #deprecated
            initialize: function (t, e) {

                this._map = t,
                    this._container = t._container,
                    // this._container = L.DomUtil.get('modal_draw_body_row'),
                    this._overlayPane = t._panes.overlayPane,
                    this._popupPane = t._panes.popupPane,
                    e && e.shapeOptions && (e.shapeOptions = L.Util.extend({}, this.options.shapeOptions)),
                    L.setOptions(this, e)
            },
            enable: function () {
        ...
        L.Draw.Polyline = L.Draw.Feature.extend({
            ...
            initialize: function (t, e) {
                L.Browser.touch && (this.options.icon = this.options.touchIcon), this.options.drawError.message = L.drawLocal.draw.handlers.polyline.error,
            ...
            addVertex: function (t) {
                ...
                return e >= 2 && !this.options.allowIntersection && this._poly.newLatLngIntersects(t) ?
                    ...
                    (this._errorShown && this._hideErrorTooltip(),
                        ...
                        2 === this._poly.getLatLngs().length && this._map.addLayer(this._poly), void this._vertexChanged(t, !0))
            },
            completeShape: function () {
                this._markers.length <= 1 || (this._fireCreatedEvent(), this.disable(), this.options.repeatMode && this.enable())
            },
            _finishShape: function () {
                var t = this._poly._defaultShape ? this._poly._defaultShape() : this._poly.getLatLngs(), e = this._poly.newLatLngIntersects(t[t.length - 1]); return !this.options.allowIntersection && e || !this._shapeIsValid() ? void this._showErrorTooltip() : (this._fireCreatedEvent(), this.disable(), void (this.options.repeatMode && this.enable()))
            },
            ...
            _endPoint: function (e, i, o) {
                if (this._mouseDownOrigin) {
                    var n = L.point(e, i).distanceTo(this._mouseDownOrigin), s = this._calculateFinishDistance(o.latlng);
                    s < 10 && L.Browser.touch ? this._finishShape() : Math.abs(n) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng),
                        this._enableNewMarkers()
                }
                this._mouseDownOrigin = null
            },
            _onTouch: function (t) {
                var e, i, o = t.originalEvent; !o.touches || !o.touches[0] || this._clickHandled || this._touchHandled || this._disableMarkers || (e = o.touches[0].clientX, i = o.touches[0].clientY, this._disableNewMarkers(), this._touchHandled = !0, this._startPoint.call(this, e, i), this._endPoint.call(this, e, i, t), this._touchHandled = null), this._clickHandled = null
            },
            ...
            _calculateFinishDistance: function (t) {
                ...
                if (this._markers.length > 0) {
                    ...
                    var o = this._map.latLngToContainerPoint(i.getLatLng()),
                        n = new L.Marker(t, {
                            icon: this.options.icon, zIndexOffset: 2 * this.options.zIndexOffset
                        }),
                        s = this._map.latLngToContainerPoint(n.getLatLng()); e = o.distanceTo(s)
                }
                else
                    e = 1 / 0;
                return e
            ...
            _updateFinishHandler: function () {
                var t = this._markers.length; t > 1 && this._markers[t - 1].on("click", this._finishShape, this),
            ...
            _drawGuide: function (t, e) {
                ...
                for (this._guidesContainer || (this._guidesContainer = L.DomUtil.create("div", "leaflet-draw-guides", this._overlayPane)); h < s; h += this.options.guidelineDistance)
                    i = h / s,
                        ...
                        n.style.backgroundColor = this._errorShown ? this.options.drawError.color : this.options.shapeOptions.color, L.DomUtil.setPosition(n, o)
            },
            ...
            _getTooltipText: function () {
                ...
                return L.Browser.touch && (i = !1),
                    0 === this._markers.length ? t = {
            ...
            _getMeasurementString: function () {
                ...
                return t = this._measurementRunningTotal + e.distanceTo(i),
                    L.GeometryUtil.readableDistance(t, this.options.metric, this.options.feet, this.options.nautic)
            },
            _showErrorTooltip: function () {
                this._errorShown = !0, this._tooltip.showAsError().updateContent({ text: this.options.drawError.message }), this._updateGuideColor(this.options.drawError.color),
                    this._poly.setStyle({ color: this.options.drawError.color }),
                    this._clearHideErrorTimeout(),
                    this._hideErrorTimeout = setTimeout(L.Util.bind(this._hideErrorTooltip, this),
        ...
        L.Draw.Polygon = L.Draw.Polyline.extend({
            statics: { TYPE: "polygon" }, Poly: L.Polygon, options: {
                showArea: !1, shapeOptions: {
                    stroke: !0,
                    color: '#333333',
                    weight: 4,
                    opacity: .5,
            ...
            _updateFinishHandler: function () {
                var t = this._markers.length; 1 === t && this._markers[0].on("click", this._finishShape, this),
            ...
            _getTooltipText: function () {
                ...
                return 0 === this._markers.length ? t = L.drawLocal.draw.handlers.polygon.tooltip.start :
                    this._markers.length < 3 ? t = L.drawLocal.draw.handlers.polygon.tooltip.cont :
            ...
            _onMouseDown: function (t) {
                this._isDrawing = !0,
                    ...
                    L.DomEvent.on(e, "mouseup", this._onMouseUp, this)
                        .on(e, "touchend", this._onMouseUp, this).preventDefault(t.originalEvent)
            },
            _onMouseMove: function (t) {
                var e = t.latlng;
        ...
        L.Draw.Rectangle = L.Draw.SimpleShape.extend({
            ...
            _drawShape: function (t) {
                this._shape ? this._shape.setBounds(new L.LatLngBounds(this._startLatLng, t)) :
                    (this._shape = new L.Rectangle(new L.LatLngBounds(this._startLatLng, t), this.options.shapeOptions),
                        this._map.addLayer(this._shape))
            },
            _fireCreatedEvent: function () {
                this.options.shapeOptions.color = 'red';
            ...
            _getTooltipText: function () {
                ...
                return n && (t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(),
                    e = L.GeometryUtil.geodesicArea(t), i = s ? L.GeometryUtil.readableArea(e, this.options.metric) : ""),
                {
                    text: o.text,
                    subtext: i
                }
        ...
        L.Draw.Circle = L.Draw.SimpleShape.extend({
            ...
            _drawShape: function (t) {
                this._shape ? this._shape.setRadius(this._startLatLng.distanceTo(t)) :
                    (this._shape = new L.Circle(this._startLatLng, this._startLatLng.distanceTo(t), this.options.shapeOptions), this._map.addLayer(this._shape))
            },
            _fireCreatedEvent: function () {
                var t = new L.Circle(
                    this._startLatLng,
            ...
            _onMouseMove: function (t) {
                ...
                if (this._tooltip.updatePosition(i), this._isDrawing) {
                    ...
                    o && (s = L.drawLocal.draw.handlers.circle.radius + ": " + L.GeometryUtil.readableDistance(e, n, this.options.feet, this.options.nautic)),
                        this._tooltip.updateContent({ text: this._endLabelText, subtext: s })
                }
            }
        }),
        L.Draw.Marker = L.Draw.Feature.extend({
            ...
            _onMouseMove: function (t) {
                if(optionColorDraw.length > 0)
                    this.options.icon.options.iconUrl = '../../../images/options/markers/m_' + optionColorDraw +'.png';
                var e = t.latlng;
                this._tooltip.updatePosition(e),
                    ...
                    this._marker ? (e = this._mouseMarker.getLatLng(), this._marker.setLatLng(e)) : (this._marker = new L.Marker(e, {
                        icon: this.options.icon, zIndexOffset: this.options.zIndexOffset
                    }),
        ...
        L.Edit = L.Edit || {}, L.Edit.Marker = L.Handler.extend({
            initialize: function (t, e) { this._marker = t, L.setOptions(this, e) }, addHooks: function () {
        ...
        L.Edit.Poly = L.Handler.extend({
            ...
            _defaultShape: function () {
                return L.Polyline._flat ? L.Polyline._flat(this._poly._latlngs) ?
        ...
        L.Edit.PolyVerticesEdit = L.Handler.extend({
            ...
            initialize: function (t, e, i) {
                L.Browser.touch && (this.options.icon = this.options.touchIcon),
                    this._poly = t, i && i.drawError && (i.drawError = L.Util.extend({}, this.options.drawError, i.drawError)),
                    this._latlngs = e,
                    L.setOptions(this, i)
            },
            _defaultShape: function () {
            ...
            _initMarkers: function () {
                ...
                for (t = 0, e = i - 1; t < i; e = t++)
                    (0 !== t || L.Polygon && this._poly instanceof L.Polygon)
                        &&
                        (s = this._markers[e], a = this._markers[t], this._createMiddleMarker(s, a), this._updatePrevNext(s, a))
            },
            _createMarker: function (t, e) {
                ...
                return i._origLatLng = t, i._index = e,
                    ...
                    this._markerGroup.addLayer(i), i
            },
            ...
            _onMarkerDrag: function (t) {
                var e = t.target,
                    i = this._poly;
                if (L.extend(e._origLatLng, e._latlng), e._middleLeft &&
                    e._middleLeft.setLatLng(this._getMiddleLatLng(e._prev, e)), e._middleRight &&
                    e._middleRight.setLatLng(this._getMiddleLatLng(e, e._next)), i.options.poly) {
                    ...
                    if (!i.options.poly.allowIntersection && i.intersects()) {
                        ...
                        i.setStyle({
                            ...
                            this._onMarkerClick(t), o && o.updateContent({
            ...
            _onMarkerClick: function (t) {
                ...
                this._defaultShape().length < e ||
                    (this._removeMarker(i),
                        ...
                        i._prev && i._next ?
                            this._createMiddleMarker(i._prev, i._next) : i._prev ?
                                i._next || (i._prev._middleRight = null) : i._next._middleLeft = null, this._fireEdit())
            },
            ...
            _getMiddleLatLng: function (t, e) {
                var i = this._poly._map,
                    o = i.project(t.getLatLng()), n = i.project(e.getLatLng());
        ...
        L.Map.TouchExtend = L.Handler.extend({
            ...
            removeHooks: function () {
                L.DomEvent.off(this._container, "touchstart", this._onTouchStart),
                    ...
                    this._detectIE() ? (L.DomEvent.off(this._container, "MSPointerDowm", this._onTouchStart),
            ...
            _initInteractionLegacy: function () {
                if (this.options.clickable) {
                    ...
                    this._detectIE ? e.concat(["MSPointerDown", "MSPointerUp", "MSPointerMove", "MSPointerCancel"]) :
                        e.concat(["touchcancel"]), L.DomUtil.addClass(t, "leaflet-clickable"),
        ...
        L.Polyline.include({
            ...
            _lineSegmentsIntersectsRange: function (t, e, i, o) {
                ...
                o = o || 0;
                for (var r = i; r > o; r--)
                    if (n = a[r - 1], s = a[r], L.LineUtil.segmentsIntersect(t, e, n, s))
                        return !0;
                return !1
            },
        ...
        L.Polygon.include({
            intersects: function () { var t, e, i, o, n, s = this._getProjectedPoints(); return !this._tooFewPointsForIntersection() && (!!(t = L.Polyline.prototype.intersects.call(this)) || (e = s.length, i = s[0], o = s[e - 1], n = e - 2, this._lineSegmentsIntersectsRange(o, i, n, 1))) }
        }),
        L.Control.Draw = L.Control.extend({
            options: {
                position: "topleft", draw: {}, edit: !1
            },
            initialize: function (t) {
                ...
                var e;
                this._toolbars = {}, L.DrawToolbar && this.options.draw && (e = new L.DrawToolbar(this.options.draw),
            ...
            onAdd: function (t) {
                var e,
                    ...
                    // i = L.DomUtil.get("modal_draw_body_row"),
                    o = !1, n = "leaflet-draw-toolbar-top";
        ...
        L.Map.mergeOptions({
            drawControlTooltips: !0, drawControl: !1
        }),
        ...
        L.Toolbar = L.Class.extend({
            ...
            addToolbar: function (t) {
                ...
                if (o)
                    return this._lastButtonIndex = --o,
                        ...
                        i.appendChild(this._toolbarContainer), i.appendChild(this._actionsContainer), i
            },
            ...
            _initModeHandler: function (t, e, i, o, n) {
                ...
                this._actionsContainer.style.display = "none", L.DomUtil.removeClass(this._toolbarContainer,
                    "leaflet-draw-toolbar-notop"), L.DomUtil.removeClass(this._toolbarContainer, "leaflet-draw-toolbar-nobottom"), L.DomUtil.removeClass(this._actionsContainer, "leaflet-draw-actions-top"), L.DomUtil.removeClass(this._actionsContainer, "leaflet-draw-actions-bottom")
            }
        }),
        ...
        L.EditToolbar.Delete = L.Handler.extend({ statics: { TYPE: "remove" }, 
        includes: L.Evented.prototype, //includes: L.Mixin.Events,  #Deprecated
